 ...
 * @brief          Definition of the serial class
 *
 * @author         Ramon de Klein (Ramon.de.Klein@ict.nl), zhenglinjun
 * @date           2015-09-06
 *
 * @note
 *
...
//    0 or INFINITE are valid.
    ...
    public:
        ...
        // @fn          CheckPort
        // @brief       Check if particular COM-port is available (static method).
        // @param[in]   lpszDevice -- 设备名称
        // @return      EPort
        ...
        // @brief
        // @param[in]   lpszDevice  -- 设备名称
        // @param[in]   dwInQueue   -- 输入队列大小
        // @param[in]   dwOutQueue  -- 输出队列大小
        // @param[in]   fOverlapped -- 是否重叠
        // @return      last error
        ...
        // @param[in]   eDataBits -- 数据位
        // @param[in]   eParity   -- 奇偶校验位
        // @param[in]   eStopBits -- 停止位
        // @return      last error
        ...
        // @fn          SetEventChar
        // @brief
        // @param[in]   bEventChar  -- 事件字符
        // @param[in]   fAdjustMask -- 是否自动适应
        // @return      last error
        ...
        // @fn          WaitEvent
        // @brief
        // @param[in]   lpOverlapped -- LPOVERLAPPED 异步I/O
        // @param[in]   dwTimeout    -- 超时
        // @return      none
        ...
        //    preferred setting.
        // @fn          SetupReadTimeouts
        // @brief
        // @param[in]   eReadTimeout -- 读取超时
        // @return      last error
        ...
        // @brief
        // @param[in]   pData        -- 写入数据
        // @param[in]   iLen         -- 写入数据长度
        // @param[out]  pdwWritten   -- 已经写入的数据长度
        // @param[in]   lpOverlapped -- 异步I/O
        // @param[in]   dwTimeout    -- 写入超时
        // @return      last error
        virtual LONG Write (const void* pData, size_t iLen, DWORD* pdwWritten = 0, LPOVERLAPPED lpOverlapped = 0, DWORD dwTimeout = INFINITE);

        // @fn          Write
        // @brief
        // @param[in]   pString      -- 写入数据，NULL结尾的字符串
        // @param[out]  pdwWritten   -- 已经写入的数据长度
        // @param[in]   lpOverlapped -- 异步I/O
        // @param[in]   dwTimeout    -- 写入超时
        // @return      last error
        ...
        LONG SetDtrSta(int nSta);
        LONG SetRtsSta(int nSta);
...
// Attributes
    ...
    protected:
        ...
        // @fn          CancelCommIo
        // @brief       CancelIo wrapper (for Win95 compatibility)
        // @param[in]   none
        // @return      none
